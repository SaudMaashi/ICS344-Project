...
exports.handler = (event, context, callback) => {
    ...
    var auth_header = headers.Authorization || headers.authorization; if (!auth_header) { const response = { statusCode: 401, headers: { "Access-Control-Allow-Origin" : "*" }, body: JSON.stringify({"status": "err", "message": "Missing authorization header"}) }; return callback(null, response); } 
